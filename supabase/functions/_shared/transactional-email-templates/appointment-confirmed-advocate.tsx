...
const AppointmentConfirmedAdvocate = ({
  clientName, whenLabel, clinicName, providerName, practitionerName,
  location, advocatePrivateNotes, reviewUrl,
}: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Confirmed appointment added{clientName ? ` for ${clientName}` : ''}</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>Confirmed appointment added</Heading>
        <Text style={text}>The confirmed appointment is now on the client and advocate calendars.</Text>
...
export const template = {
  component: AppointmentConfirmedAdvocate,
  subject: 'Confirmed appointment added',
  displayName: 'Appointment confirmed (advocate)',
  previewData: {
    clientName: 'Jane Doe', whenLabel: 'Tue 9 Jun, 10:30am',
