...
const AppointmentReminderAdvocate = ({
  clientName, whenLabel, clinicName, providerName, practitionerName,
  location, advocatePrivateNotes, reviewUrl,
}: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Client appointment tomorrow{clientName ? ` — ${clientName}` : ''}</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>Client appointment tomorrow</Heading>
        <Text style={text}>Heads-up — your client has a confirmed appointment in about 24 hours.</Text>
...
export const template = {
  component: AppointmentReminderAdvocate,
  subject: 'Reminder: client appointment tomorrow',
  displayName: 'Appointment 24h reminder (advocate)',
  previewData: { clientName: 'Jane Doe', whenLabel: 'Tomorrow, 10:30am' },
